...
-- 正在导出表  software_factory_db.sf_menu_detail 的数据：~62 rows (大约)
...
INSERT INTO `sf_project_config` (`project_config_id`, `bind_project`, `config_param`, `project_param`, `description`, `order_num`, `isdel`, `creator`, `create_time`, `create_ip`, `updater`, `update_time`, `update_ip`) VALUES
	...
	('nb2iFt5_J7BjfWht6rXie', 'DuKc8Et3ogtTxHPnhjVeO', '{"host":"localhost","port":3306,"type":"mysql","username":"root","password":"123456","database":"xyd_db"}', '{"prefix":"base/api"}', NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL),
